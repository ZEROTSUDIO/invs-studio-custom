        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-info">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url('dashboard/portofolio_aksi') ?>" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="form-group col-md-9">
                                    <label for="portofolio_nama" class="form-label">Nama portofolio</label>
                                    <input type="text" class="form-control" id="portofolio_nama" name="portofolio_nama" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="form-group col-md-4">
                                    <label for="portofolio_foto" class="form-label">foto portofolio</label>
                                    <input type="file" class="form-control" id="portofolio_foto" name="portofolio_foto" required>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" id="summernote" name="portofolio_deskripsi" rows="5" required></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12">
