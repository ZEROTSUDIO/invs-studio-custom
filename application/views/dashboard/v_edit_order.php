	...
	<div style="max-width: 640px;">
		...
		<div style="margin-bottom:22px;">
			<div style="font-family:'Syne',sans-serif; font-weight:800; font-size:18px; color: var(--cream);">
				Edit Pesanan <?php echo htmlspecialchars($order->order_code); ?>
			</div>
			<div style="font-size:11px; color: var(--smoke); margin-top:4px;">
				Mengedit pesanan yang sudah dijadwalkan akan menghitung ulang antrian untuk memastikan akurasi.
			</div>
		</div>
				...
				<div style="padding:22px;">
					...
					<div class="form-group">
						...
						<?php if ($order->design_file): ?>
							<div style="font-size:11px; color:var(--smoke); margin-top:4px;">
								File saat ini: <a href="<?php echo base_url('gambar/orders/'.$order->design_file); ?>" target="_blank" style="color:#60a5fa; text-decoration:underline;"><?php echo htmlspecialchars($order->design_file); ?></a>
