...
<head>
	...
	<title>Invs Studio — Sistem Produksi</title>
	...
	<div class="sidebar">
		<div class="sidebar-logo">
			...
			<div class="sub">Sistem Produksi v1.0</div>
		</div>
		...
		<div class="nav-section" id="nav-admin">
			...
			<a href="<?php echo base_url() . 'dashboard/new_order' ?>" class="nav-item <?php echo ($this->uri->segment(2) == "new_order") ? 'active' : ''; ?>">
				<span class="icon">+</span> Pesanan Baru
			</a>
			...
			<a href="<?php echo base_url() . 'dashboard/schedule' ?>" class="nav-item <?php echo ($this->uri->segment(2) == "schedule") ? 'active' : ''; ?>">
				<span class="icon">◫</span> Jadwal Produksi
			</a>
			...
			<a href="<?php echo base_url() . 'dashboard/schedule_legacy' ?>" class="nav-item <?php echo ($this->uri->segment(2) == "schedule_legacy") ? 'active' : ''; ?>">
				<span class="icon">◫</span> Jadwal (24j)
			</a>
		...
		<div class="sidebar-footer">
			<div style="font-size:9px; color: var(--smoke); letter-spacing:0.15em; text-transform:uppercase; margin-bottom:8px;">Algoritma SJF</div>
			<div style="font-size:11px; color: var(--ember);">⟳ Antrian Aktif</div>
			<div style="font-size:10px; color: var(--smoke); margin-top:4px;">14 pesanan dalam antrian</div>
		</div>
	</div>
	...
	<div class="main">
		...
		<!-- TOPBAR -->
		<div class="topbar">
			<div class="page-title" id="topbar-title"><?php echo isset($page_title) ? $page_title : 'Dashboard Admin'; ?></div>
