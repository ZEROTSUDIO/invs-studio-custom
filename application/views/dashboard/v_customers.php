...
<div class="page active">
	<div style="display:flex; justify-content:space-between; margin-bottom:18px; align-items:center;">
		<div style="font-family:'Syne',sans-serif; font-weight:700; font-size:16px; color: var(--cream);">Daftar Pelanggan</div>
	</div>
	...
	<div class="panel">
		<div class="panel-header">
			<div class="panel-title">
				Semua Pelanggan
				<span style="font-size:10px; color: var(--smoke); font-weight:400; margin-left:8px;"><?php echo count($customers); ?> terdaftar</span>
			</div>
		</div>
			...
			<table class="data-table">
				...
				<tbody>
					<?php if (count($customers) == 0): ?>
						<tr>
							<td colspan="4" style="text-align:center; padding:24px; color:var(--smoke);">Belum ada pelanggan.</td>
						</tr>
					<?php else: ?>
